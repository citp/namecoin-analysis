...
We now examine how .bit domains are used by legitimate users. Only 9354 out of the 141422 .bit domains make any attempt to resolve to IP addresses. Out of these a variety of types of IP resolution are employed.
...
\subsection{Examining Squatter Name Decisions}

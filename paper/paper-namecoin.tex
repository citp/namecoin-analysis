...
%%%
\newcommand{\AUTHORS}{\large{Harry Kalodner\textsuperscript{*}, Miles Carlsten\textsuperscript{*}, Paul Ellenbogen\textsuperscript{*}, Joseph Bonneau\(^{\dagger} \), Arvind Narayanan\textsuperscript{*}}\\
\small{\textsuperscript{*}\tt{\{kalodner,carlsten,pe5,arvindn\}@cs.princeton.edu}} \ \ \ \ \ \ \ \ \ \ \ 
\small{\(^{\dagger} \)\tt{jbonneau@gmail.com}}\\
...
\titlespacing{\section}{0pt}{.75ex}{.3ex}
\titlespacing{\subsection}{0pt}{.6ex}{\parskip}
...
\clearpage
\appendix
\section{List of significant .bit domains}
Below is a list of names counted towards the last entry in Table \ref{table:significant_domains}. These domains were determined by the proccess described in Section \ref{sec:domains}.
\begin{itemize}

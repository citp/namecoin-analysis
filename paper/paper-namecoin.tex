...
%%%
\newcommand{\AUTHORS}{\normalsize{Harry Kalodner\textsuperscript{*}, Miles Carlsten\textsuperscript{*}, Paul Ellenbogen\textsuperscript{*}, Joseph Bonneau\(^{\dagger} \), Arvind Narayanan\textsuperscript{*}}\\
\normalsize{\tt{\{kalodner, carlsten, pe5, arvindn\} @cs.princeton.edu}}\textsuperscript{*}\\
\normalsize{\tt{jbonneau@gmail.com}}\(^{\dagger} \) \\
